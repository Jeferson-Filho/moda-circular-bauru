        ...
        <div class="container">
            ...
            <div class="tipos-moda__body">
                <div class="tipos-moda__body--brechos types">
                    ...
                    <p>Disponíveis tanto em lojas físicas quanto em plataformas online, os brechós oferecem desde itens casuais até roupas de luxo, permitindo que os consumidores adotem um estilo mais consciente e sustentável, ao mesmo tempo em que exploram peças únicas e cheias de história.</p>
                    <p>Além de serem uma alternativa mais sustentável ao consumo de moda, os brechós também promovem a criatividade e a individualidade. Encontrar peças vintage ou estilos que já saíram de circulação pode ser uma forma de expressar a personalidade por meio da moda, ao mesmo tempo em que se apoia uma causa ambiental.</p>
                </div>
                <div class="tipos-moda__body--aluguel types">
                    <h2 class="subtitle">Aluguel</h2>
                ...
                <div class="tipos-moda__body--upcycling types">
                    <h2 class="subtitle">Upcycling</h2>
                ...
                <div class="tipos-moda__body--customizacao types">
                    <h2 class="subtitle">Customizacao</h2>
                ...
                <div class="tipos-moda__body--reciclagem types">
                    <h2 class="subtitle">Reciclagem</h2>
                ...
                <div class="tipos-moda__body--ressignificacao types">
                    <h2 class="subtitle">Ressignificação</h2>
